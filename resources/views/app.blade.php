...
<head>
	...
	@if(Config::get('app.debug'))
		...
		<link rel="stylesheet" type="text/css" href="{{asset('build/css/vendor/angular-ui-notification.min.css')}}">
...
<body>
	...
	@if(Config::get('app.debug'))
		...
		<!-- SERVICES !-->
		<script src="{{asset('build/js/services/url.js')}}">
		</script>
		<script src="{{asset('build/js/services/oauthFixInterceptor.js')}}">
		</script>
		<script src="{{asset('build/js/services/client.js')}}">
		</script>
		<script src="{{asset('build/js/services/project.js')}}">
		</script>
